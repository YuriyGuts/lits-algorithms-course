...
\begin{center}
    \begin{tikzpicture}
        \begin{scope}[every node/.style={blank}]
            ...
            \node at (0.5,0.5) (n11) {|2|};
            \node at (1.5,0.5) (n21) {|1|};
            \node at (2.5,0.5) (n31) {|2|};
            \node at (3.5,0.5) (n41) {|3|};
            \node at (4.5,0.5) (n51) {|4|};
            \node at (0.5,1.5) (n12) {|1|};
            \node at (1.5,1.5) (n22) {};
            \node at (2.5,1.5) (n32) {|1|};
            \node at (3.5,1.5) (n42) {|2|};
            \node at (4.5,1.5) (n52) {|3|};
            \node at (0.5,2.5) (n13) {|2|};
            \node at (1.5,2.5) (n23) {|1|};
            \node at (2.5,2.5) (n33) {|2|};
            \node at (3.5,2.5) (n43) {|3|};
            \node at (4.5,2.5) (n53) {|4|};
            \node at (0.5,3.5) (n14) {|3|};
            \node at (1.5,3.5) (n24) {|2|};
            \node at (2.5,3.5) (n34) {|3|};
            \node at (3.5,3.5) (n44) {|4|};
            \node at (4.5,3.5) (n54) {};
            \node at (0.5,4.5) (n15) {|4|};
            \node at (1.5,4.5) (n25) {|3|};
            \node at (2.5,4.5) (n35) {|4|};
            \node at (3.5,4.5) (n45) {};
            \node at (4.5,4.5) (n55) {};
