...
Коли ми мали справу з деревовидними структурами, обходити їх було нескладно. Достатньо було запустити рекурсивну функцію на кореневому вузлі, і вона рівно один раз відвідає кожен вузол, що лежить у цьому дереві.
...
Існує дві стратегії обходу графів: \textbf{пошук в ширину} (Breadth-First Search, BFS) та \textbf{пошук у глибину} (Depth-First Search, DFS).
...
\begin{enumerate}
    ...
    \item Перевіряємо, чи ми вже в ній були (\(visited(v) = 1?\)). Якщо так, повертаємося до пункту 2.
...
Якщо проаналізувати, як ці два обходи відвідують вершини, можна помітити такі закономірності:
\begin{itemize}
